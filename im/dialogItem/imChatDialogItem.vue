<template>
    <!-- 好友消息 -->
    <div class="im-chat-dialog-item" :class="dialogClass">
        <yd-avator class="dialog-avator" :user="dialog.json.entity" :name="dialog.title" size="4" />
 ...
 * @Last Modified time: 2019-03-09 09:22:34
 * @desc Dialog Item
 * from id:
 * 普通用户：(0 - 100000000)
